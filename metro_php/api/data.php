...
// endTime - время когда поезд останавливается
// finalTime - время когда поезд перестает перевозить пассажиров, после этого он может еще двигаться в депо поэтому endTime > finalTime
$routes = [
    ...
    5 => ["lineID" => 1, "startStationIndex" => 0, "direction" => 1, "startTime" => (5 * SECONDS_IN_HOUR + 35 * SECONDS_IN_MINUTE), "endTime" => (22 * SECONDS_IN_HOUR + 22 * SECONDS_IN_MINUTE), "finalTime" => (22 * SECONDS_IN_HOUR + 5 * SECONDS_IN_MINUTE)],
    ...
    7 => ["lineID" => 1, "startStationIndex" => 5, "direction" => 1, "startTime" => (5 * SECONDS_IN_HOUR + 37 * SECONDS_IN_MINUTE), "endTime" => (22 * SECONDS_IN_HOUR + 2 * SECONDS_IN_MINUTE), "finalTime" => (21 * SECONDS_IN_HOUR + 45 * SECONDS_IN_MINUTE)]
];
